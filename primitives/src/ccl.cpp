...
void labelPixel(int x, int y, int width, int height, const float* values, int* labels, int& labelMax, std::map<int, std::vector<int>>& equivalentLabels) {
